<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_SubTask.aspx.cs" Inherits="AyEServicesCRM.M_SubTask" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-8" align="right">
            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add SubTask 
            </asp:LinkButton>
        </div>
    </div>           
     
    <asp:ListView ID="lvw_SubTask" runat="server" DataKeyNames="IdSubTasks" EnableTheming="True" OnSelectedIndexChanging="lvw_SubTask_SelectedIndexChanging">
        <LayoutTemplate>
            <table class="table table-striped table-bordered" id="myTable">
                <thead>
                    <tr>
                        <th class="text-center">Name SubTask</th>
                        <th class="text-center">Mes</th>
                        <th class="text-center">Type Task</th>
        ...
        <ItemTemplate>
            <tr>
                <td class="text-center"><%# Eval ("NameSubtask") %></td>
                <td class="text-center"><%# Eval ("Mes") %></td>
                <td class="text-center"><%# Eval ("TypeTask") %></td>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="form-group"><strong>Name Task:</strong></h5>
                                    <div class="input-group date col-sm-12">
                                        <asp:TextBox ID="txtNameTask" class="form-control" AutoComplete="off" required="required" runat="server" CssClass="form-control" MaxLength="80" BackColor="White" TabIndex="1"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="form-group"><strong>Mes:</strong></h5>
                                    <div class="input-group date col-sm-12">
                                        <asp:DropDownList ID="cboMes" runat="server" BackColor="White" AutoPostBack="true" CssClass="form-control" TabIndex="7" OnSelectedIndexChanged="cboMes_SelectedIndexChanged">
                                    ...
                                    <asp:Label ID="lblmes" runat="server" Text="1" Visible="false"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group date col-sm-12">
                                        <asp:DropDownList ID="cboTypeTask" runat="server"  required="required" BackColor="White" AutoPostBack="false" CssClass="form-control" TabIndex="7"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group date col-sm-12">
                                        <asp:DropDownList ID="cboStatus" runat="server"  required="required" BackColor="White" AutoPostBack="false" CssClass="form-control" TabIndex="7"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
