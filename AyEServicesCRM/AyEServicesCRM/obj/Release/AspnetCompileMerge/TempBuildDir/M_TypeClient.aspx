<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_TypeClient.aspx.cs" Inherits="AyEServicesCRM.M_TypeClient" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-8" align="right">
            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add Type Client 
            </asp:LinkButton>
        </div>
    </div>           
     
    <asp:ListView ID="lvw_Type" runat="server" DataKeyNames="IdTypeClient" EnableTheming="True" OnSelectedIndexChanging="lvw_Type_SelectedIndexChanging">
        <LayoutTemplate>
            <table class="table table-striped table-bordered" id="myTable">
                <thead>
                    <tr>
                        <th class="text-center" width="85%">Type Clients (Name)</th>
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="form-group"><strong>Type Client(Name):</strong></h5>
                                        <div class="input-group date col-sm-12">
                                            <asp:TextBox ID="txtName" class="form-control" AutoComplete="off" required="required"  runat="server" CssClass="form-control" MaxLength="100" BackColor="White" TabIndex="1"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
