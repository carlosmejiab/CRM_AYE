<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_Citys.aspx.cs" Inherits="AyEServicesCRM.M_Citys" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">    
    ...
    <div class="row">
        ...
        <div class="col-xs-8" align="right">
            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add Location 
            </asp:LinkButton>
        </div>
    </div>           
     
    <asp:ListView ID="lvw_City" runat="server" DataKeyNames="IdCity" EnableTheming="True" OnSelectedIndexChanging="lvw_City_SelectedIndexChanging">
        <LayoutTemplate>
            <table class="table table-striped table-bordered" id="myTable">
                <thead>
                    <tr>
                        <th class="text-center" width="40%">Name State</th>
                        <th class="text-center" width="40%">City</th>
        ...
        <ItemTemplate>
            <tr>
                <td class="text-center"><%# Eval ("NameState") %></td>
                <td class="text-center"><%# Eval ("NombreCity") %></td>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="form-group"><strong>Name State:</strong></h5>
                                    <div class="input-group date col-sm-12">
                                        <asp:DropDownList ID="cboState" runat="server" BackColor="White" AutoPostBack="false" CssClass="form-control" TabIndex="7"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="form-group"><strong>Name City:</strong></h5>
                                    <div class="input-group date col-sm-12">
                                        <asp:TextBox ID="txtNameCity" class="form-control" AutoComplete="off" required="required" runat="server" CssClass="form-control" MaxLength="100" BackColor="White" TabIndex="1"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
