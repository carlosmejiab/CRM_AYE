<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_Priority.aspx.cs" Inherits="AyEServicesCRM.M_Priority" %>
    ...
    <script type="text/javascript">
       ...
       <div class="row">
                ...
                <div class="col-xs-8" align="right">  
                     <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add Priority 
                    </asp:LinkButton>
                </div>
            </div>           
     
       <asp:ListView ID="lvw_Priority" runat="server" DataKeyNames="IdTabla" EnableTheming="True" OnSelectedIndexChanging="lvw_Priority_SelectedIndexChanging">
                <LayoutTemplate>
                    <table class="table table-striped table-bordered" id="myTable">
                        <thead>
                            <tr>
                                <th class="text-center" width="85%">Priority</th>                              
