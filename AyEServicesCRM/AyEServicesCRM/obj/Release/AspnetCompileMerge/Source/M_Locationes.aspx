<%@ Page Title="" ClientIDMode="Static" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_Locationes.aspx.cs" Inherits="AyEServicesCRM.M_Locationes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">  
    ...
    <script type="text/javascript">
       ...
       <asp:ListView ID="lvw_Locationes" runat="server" DataKeyNames="IdTabla" EnableTheming="True" OnSelectedIndexChanging="lvw_Locationes_SelectedIndexChanging">
                <LayoutTemplate>
                    <table class="table table-striped table-bordered" id="myTable">
                        <thead>
                            <tr>
                                <th class="text-center" width="85%">Locationes</th>                              
