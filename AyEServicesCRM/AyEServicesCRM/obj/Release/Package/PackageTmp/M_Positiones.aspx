<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_Positiones.aspx.cs" Inherits="AyEServicesCRM.M_Positiones" %>
    ...
    <script type="text/javascript">
      ...
      <div class="row">
                ...
                <div class="col-xs-8" align="right">  
                     <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add Position 
                    </asp:LinkButton>
                </div>
            </div>           
     
       <asp:ListView ID="lvw_Positiones" runat="server" DataKeyNames="IdTabla" EnableTheming="True" OnSelectedIndexChanging="lvw_Positiones_SelectedIndexChanging">
                <LayoutTemplate>
                    <table class="table table-striped table-bordered" id="myTable">
                        <thead>
                            <tr>
                                <th class="text-center" width="85%">Positiones</th>                              
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="form-group"><strong>Positiones:</strong></h5>
