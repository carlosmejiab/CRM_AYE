<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_State.aspx.cs" Inherits="AyEServicesCRM.M_State" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-8" align="right">
            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add State 
            </asp:LinkButton>
        </div>
    </div>           
     
    <asp:ListView ID="lvw_State" runat="server" DataKeyNames="IdState" EnableTheming="True" OnSelectedIndexChanging="lvw_State_SelectedIndexChanging">
        <LayoutTemplate>
            <table class="table table-striped table-bordered" id="myTable">
                <thead>
                    <tr>
                        <th class="text-center" width="85%">State</th>
        ...
        <ItemTemplate>
            <tr>
                <td class="text-left"><%# Eval ("NameState") %></td>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group date col-sm-12">
                                            <asp:TextBox ID="txtState" class="form-control" AutoComplete="off" required="required"  runat="server" CssClass="form-control" MaxLength="100" BackColor="White" TabIndex="1"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
