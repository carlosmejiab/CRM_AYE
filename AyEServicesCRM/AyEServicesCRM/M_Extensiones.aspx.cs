...
{
    public partial class M_Extensiones : System.Web.UI.Page
    {
        DataSet ds;
        DataTable dt;
        DataRow dr;
        ModuloConstructor ca = new ModuloConstructor();
        public void ListarExtesion()
        {
            lvw_Extesiones.DataSource = ca.ListarMultiplesTablasTodo("MExtension");
            lvw_Extesiones.DataBind();
        }
        ...
        {
            ds = ca.ListarMultiplesTablasTodo("MExtensionIdOrd");
            dt = ds.Tables[0];
        ...
        protected void lvw_Extesiones_SelectedIndexChanging(object sender, ListViewSelectEventArgs e)
        {
            txtCodigo.Text = lvw_Extesiones.DataKeys[e.NewSelectedIndex].Value.ToString();
            ds = ca.ListarMultiplesTablasPorCodigo("MExtension", Convert.ToInt32(txtCodigo.Text));
            dt = ds.Tables[0];
