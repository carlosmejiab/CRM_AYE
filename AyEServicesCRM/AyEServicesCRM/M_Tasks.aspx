...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-xs-3" align="Left">
            <input type="text" id="myInput" onkeyup="FiltrarTask()" style="width: 64%" placeholder="Search for names.." title="Type in a name">
        </div>

        <div class="col-xs-3" align="Left">
            <div class="input-group">
                <label style="margin-right:8px; margin-top:10px;" for="email_address" class="col-md-3 col-form-label text-md-right">StartDate:</label>
                <asp:TextBox ID="txtStarDateSearch" class="form-control" Width="205px" AutoComplete="off" runat="server" CssClass="form-control" BackColor="White" TabIndex="5" Height="40px" TextMode="Date"></asp:TextBox>
            </div>       
        </div>       
        <div class="col-xs-4" align="Left">
            <div class="input-group">
                 <label style="margin-top:10px;" for="email_address" class="col-md-3 col-form-label text-md-right">DueDate:</label>
                <asp:TextBox ID="txtDueDateSearch" class="form-control" Width="220px" AutoComplete="off" runat="server" CssClass="form-control" BackColor="White" TabIndex="5" Height="40px" TextMode="Date"></asp:TextBox>
        ...
        <div class="col-xs-2" align="right">
            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add Task 
            </asp:LinkButton>
        </div>
    </div>  
    ...
    <asp:Panel ID="panSearch" runat="server" DefaultButton="linkBuscarTask" Width="100%" >
        ...
        <div class="col-xs-2" align="Left">
            <asp:TextBox  ID="txtTask" class="form-control"  runat="server" placeholder="Task Number:" Width="300px" TabIndex="5" Height="40px" MaxLength="300" AutoComplete="off"></asp:TextBox>

        </div>

        <div class="col-xs-1" align="Left">
                        <asp:LinkButton ID="linkBuscarTask" runat="server" CssClass="btn btn-primary" OnClick="linkBuscarTask_Click" Height="40px"><span aria-hidden="true" class="glyphicon glyphicon-search"></span>
            </asp:LinkButton>
        </div>
        ...
        <div class="col-xs-3" align="Left">
            <div class="input-group date">
                ...
                <%--<asp:DropDownList ID="cboBuscarClients" onchange="Alertando(this); return false;" style="margin-left:10px;" BackColor="White" runat="server" CssClass="form-control" TabIndex="7" Height="40px" Width="205px"></asp:DropDownList>--%>
                <asp:DropDownList ID="cboBuscarClients" AutoPostBack = "True" OnSelectedIndexChanged = "OnSelectedIndexChangedMethod" style="margin-left:10px;" BackColor="White" runat="server" CssClass="form-control" TabIndex="7" Height="40px" Width="205px"></asp:DropDownList>
               
                 <%--<input list="cboBuscarClients3" ID="cboBuscarClients1" onkeyup="FiltrarTask2()" placeholder="Start typing..." type="email" multiple>--%>   
                <%--<select id="myInput9" onkeyup="FiltrarTask2()" runat="server" name="D1">
                  </select>--%>
<%--              <input id="Button1" type="button" class="btn-info" value="Recuperar Datos" onclick="PoblarDropDown('1', 'René')" />
        ...
        <div class="col-xs-4" align="Left">
            <div class="input-group">
                <label style="margin-top:10px;" for="email_address" class="col-md-3 col-form-label text-md-right">Period:</label>
			   <asp:DropDownList onkeyup="FiltrarTask()" AutoPostBack = "True" style="margin-left:10px;" ID="cboPeriod" runat="server" BackColor="White" CssClass="form-control" TabIndex="5" Height="40px" Width="220px" OnSelectedIndexChanged="cboPeriod_SelectedIndexChanged"></asp:DropDownList>
    ...
    <div class="modal fade" id="MyModalTracking" data-backdrop="static" data-keyboard="false" role="dialog">
        <div class="modal-dialog modal-lg">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server" >
                <%--UpdateMode="Conditional" OnLoad="UpdatePanel4_Load">--%>
                <ContentTemplate>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-9" style="text-align: left">
                                            Task Name:  <asp:Label ID="lblTaskTracking" runat="server" Font-Bold="true" Text="Task Name"></asp:Label> <asp:Label ID="lblCodigoTaskTracking" runat="server" Text="Label" Visible="false"></asp:Label>
                             ...
                             <div class="row">
                                <div class="col-sm-7">
                                    ...
                                    <asp:Label ID="lblCondicion" runat="server" Text="Label" Visible="true"></asp:Label>
                                     <hr>
                                    <strong>Timelog Name</strong> <asp:Label ID="lblTimeLogSelect" runat="server" Text="Label" Visible="false"></asp:Label>  <br>
                                    <strong>Started on</strong> <asp:Label ID="lblStartedSelect" runat="server" Text="Label" Visible="false"></asp:Label><br>
                                    <strong>Ended on </strong> <asp:Label ID="lblEndedSelect" runat="server" Text="Label" Visible="false"></asp:Label><br>
                                    <strong>Time Spent</strong> <asp:Label ID="lblTimeSelect" runat="server" Text="Label" Visible="false"></asp:Label>  <strong>mm</strong><br>
                                    <strong>Status</strong> <asp:Label ID="lblStatusSelect" runat="server" Text="Label" Visible="false"></asp:Label>
                                </div>
                                 <div class="col-sm-5">                                     
                                     <div class="panel panel-default">
                                         <div class="row">
                                     ...
                                     <asp:ListView ID="lvwTrackinTask" runat="server" DataKeyNames="IdTracking,Status" EnableTheming="True" OnSelectedIndexChanging="lvwTrackinTask_SelectedIndexChanging">
                                         ...
                                         <ItemTemplate>
                                             <tr>
                                                 <td class="text-left">
                                                     <strong>Timelog Name</strong> <%# Eval ("Tracking") %>  <br>
                                     ...
                                     <asp:ListView ID="lvw_DocumentTask" runat="server" DataKeyNames="IdDocument" EnableTheming="True" OnSelectedIndexChanging="lvw_DocumentTask_SelectedIndexChanging">
                                         <LayoutTemplate>
                                             <table class="table table-striped table-bordered" id="myTable">
                                                 <thead>
                                                     <tr>
                                         ...
                                         <ItemTemplate>
                                             <tr>
                                                 <td class="text-left">
                                                    <strong>Title</strong> <%# Eval ("NameDocument") %> <br>
            ...
            <div class="modal-content">
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>                       
                            <%--<asp:Button ID="LinkSaveDoc" CssClass="btn btn-primary" runat="server" Text="Save Doc" OnClick="LinkSaveDoc_Click" TabIndex="4" ClientIDMode="Static"/>--%>
