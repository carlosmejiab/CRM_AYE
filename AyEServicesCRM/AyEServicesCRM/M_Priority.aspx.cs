...
{
    public partial class M_Priority : System.Web.UI.Page
    {
        DataSet ds;
        DataTable dt;
        DataRow dr;
        ModuloConstructor ca = new ModuloConstructor();
        public void ListarPriority()
        {
            lvw_Priority.DataSource = ca.ListarMultiplesTablasTodo("MPriority");
            lvw_Priority.DataBind();
        }
        ...
        {
            ds = ca.ListarMultiplesTablasTodo("MPriorityIdOrd");
            dt = ds.Tables[0];
        ...
        protected void lvw_Priority_SelectedIndexChanging(object sender, ListViewSelectEventArgs e)
        {
            txtCodigo.Text = lvw_Priority.DataKeys[e.NewSelectedIndex].Value.ToString();
            ds = ca.ListarMultiplesTablasPorCodigo("MPriority", Convert.ToInt32(txtCodigo.Text));
            dt = ds.Tables[0];
