<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="M_Services.aspx.cs" Inherits="AyEServicesCRM.M_Services" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-8" align="right">
            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" ClientIDMode="Static"> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> Add Services 
            </asp:LinkButton>
        </div>
    </div>           
     
    <asp:ListView ID="lvw_Services" runat="server" DataKeyNames="IdService" EnableTheming="True" OnSelectedIndexChanging="lvw_Services_SelectedIndexChanging">
        <LayoutTemplate>
            <table class="table table-striped table-bordered" id="myTable">
                <thead>
                    <tr>
                        <th class="text-center" width="40%">Service Name</th>
                        <th class="text-center" width="30%">Client Type</th>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="text-center"><%# Eval ("ClientType") %></td>
                <td class="text-center"><%# Eval ("Price") %></td>
                <td class="text-center"><%# Eval ("IdStatusService") %></td>
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            ...
                            <div class="modal-body">                               
                                <div class="row">                                   
                                    <div class="col-sm-6">
                                        <h5 class="form-group"><strong>Service Name:</strong></h5>
                                        <div class="input-group date col-sm-12">
                                            <asp:TextBox ID="txtServiceName" class="form-control" AutoComplete="off" required="required"  runat="server" CssClass="form-control" MaxLength="100" BackColor="White" TabIndex="1"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="col-sm-6">
                                        <h5 class="form-group"><strong>Client Type:</strong></h5>
                                        <div class="input-group date col-sm-12">
                                            <asp:DropDownList ID="cboClientType" required="required" runat="server" BackColor="White" AutoPostBack="false" CssClass="form-control" TabIndex="7"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6">
                                        <h5 class="form-group"><strong>Price:</strong></h5>
                                        <div class="input-group date col-sm-12">
                                            <asp:TextBox ID="txtPrice" class="form-control" AutoComplete="off"   runat="server" CssClass="form-control" MaxLength="100" BackColor="White" TabIndex="1"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group date col-sm-12">
                                            <asp:TextBox ID="txtDescription" class="form-control" AutoComplete="off"  runat="server" CssClass="form-control" MaxLength="100" BackColor="White" TabIndex="1" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
